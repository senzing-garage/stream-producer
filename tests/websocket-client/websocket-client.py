...
# -----------------------------------------------------------------------------
# websocket-client.py Example websocket-client.
# -----------------------------------------------------------------------------
...
def get_parser():
    ...
    subcommands = {
        'websocket-client': {
            "help": 'Send to WebSocket.',
            "argument_aspects": ["common", "sqs", "input"],
            "arguments": {
                "--senzing-dir": {
                    "dest": "senzing_dir",
                    "metavar": "SENZING_DIR",
    ...
    argument_aspects = {
        ...
        "input": {
            "--input-file": {
                ...
                "help": "Input file for testing. Default: none"
            },
        },
        "sqs": {
            "--sqs-queue-url": {
    ...
    parser = argparse.ArgumentParser(description="Web service to send stream to queue. For more information, see https://github.com/Senzing")
